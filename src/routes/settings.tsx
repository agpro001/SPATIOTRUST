    ...
    <div className="p-5 space-y-6 max-w-3xl">
      ...
      >
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Tune how strict the oracle is. Higher confidence sensitivity rejects
            borderline structures; higher base-support tolerance accepts
            slightly off-centre buildings.
          </p>
        </div>
        <Slider
      ...
      <section className="rounded-md border border-border bg-surface/60 p-5 space-y-2">
        ...
        <div className="font-mono text-xs text-muted-foreground space-y-1">
          ...
          <div>AI endpoint: <span className="text-foreground">/api/ai-chat · AI Mesh</span></div>
        </div>
      </section>
    </div>
  );
